...
<body>
    ...
    <div class="container">
	<div class="col-sm"><a class="btn btn-primary" href="../view/add_user.php" role="button">ADD DATA</a></div>
            ...
            <?php
                ...
                foreach($db->showdata() as $x) {
                    ...
                    echo "<tr>";
						...
						echo "<td>" . $x['role_name'] . "</td>";
						if($x['role_id'] == 1) continue;
                        echo "<td><a href=\"../view/edituser.php?id=$id\"><span class=\"fa fa-edit\"></span></a>&nbsp&nbsp&nbsp
                                  <a href=\"../controller/deleteuser.php?id=$id\" name=\"\" ><span class=\"fa fa-times\"></span></a>
                              </td>";
                    echo "</tr>";
                }
            ?>        
